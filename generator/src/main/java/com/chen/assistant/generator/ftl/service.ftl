package com.chen.assistant.${module}.service;
...
import com.chen.assistant.${module}.domain.${Domain};
import com.chen.assistant.${module}.domain.${Domain}Example;
import com.chen.assistant.${module}.mapper.${Domain}Mapper;
